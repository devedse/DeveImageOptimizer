...
namespace DeveImageOptimizer.Tests.FileProcessingCompareDirectVsFileOptimizer
{
    public class FileOptimizeSizeCompareFacts
    {
        ...
        {
            var configFileOptimizer = ConfigCreator.CreateTestConfig(true, directMode: true);
            var configNew = ConfigCreator.CreateTestConfig(true, directMode: false);
