...
$7zFilePath = Join-Path $outputDir "DeveImageOptimizer.7z"
$zipFilePath = Join-Path $outputDir "DeveImageOptimizer.zip"

DeleteFileIfExists $7zFilePath
DeleteFileIfExists $zipFilePath
DeleteFolderIfExists $outputDir

$buildPath = Join-Path $solutionRoot "DeveImageOptimizer\bin\Release"
